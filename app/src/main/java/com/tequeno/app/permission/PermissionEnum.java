package com.tequeno.app.permission;
...
public enum PermissionEnum {
    ...
    ACCESS_FINE_LOCATION(40, Manifest.permission.ACCESS_FINE_LOCATION),
    ACCESS_BACKGROUND_LOCATION(41, Manifest.permission.ACCESS_BACKGROUND_LOCATION),
